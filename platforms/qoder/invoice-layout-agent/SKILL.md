...
Install this folder in `~/.qoderwork/skills` for QoderWork or `~/.qoder/skills` for Qoder CLI. Add the local stdio service with `qodercli mcp add invoice-layout -- invoice-layout mcp`.
