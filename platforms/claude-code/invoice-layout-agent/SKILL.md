...
Install this folder in `.claude/skills` or `~/.claude/skills`. Add the local stdio service with `claude mcp add --transport stdio invoice-layout -- invoice-layout mcp`.
