...
Install this folder with `openclaw skills install ./path/to/invoice-layout-agent`; supported roots include workspace `skills`, `.agents/skills`, and `~/.openclaw/skills`.
